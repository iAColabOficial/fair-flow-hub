...
ALTER TABLE areas_conhecimento ADD CONSTRAINT unique_areas_nome UNIQUE (nome);
ALTER TABLE categoria_precos ADD CONSTRAINT unique_categoria_precos UNIQUE (categoria, etapa, ano);
ALTER TABLE system_settings ADD CONSTRAINT unique_system_settings_key UNIQUE (key);
ALTER TABLE feiras_afiliadas ADD CONSTRAINT unique_feiras_nome UNIQUE (nome);
